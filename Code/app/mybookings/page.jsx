  ...
  return (
    <>
      <div className="mb-5" data-testid="external">
        This page should show all client booking, past present and future, bookings need id status date and "start-time end-time or time"
        Server still needs to verify the time sent by the user
      </div>
    </>
  );
}
